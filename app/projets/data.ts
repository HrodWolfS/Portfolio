export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Un faux blog d'actualité tech, mais un vrai projet fullstack pour prouver mes compétences.",
    longDescription:
      "TechnoGorafi est un projet de blog parodique inspiré du Gorafi, conçu pour détourner les codes du journalisme tech tout en mettant en avant mes compétences de développeur fullstack. Chaque article mêle absurdité assumée et exigence technique : génération d'images, planification d’articles, dashboard admin, gestion des tags et commentaires... Ce projet est pensé comme une vitrine à la fois drôle et sérieuse de mon savoir-faire. Il n'a aucune utilité réelle, si ce n’est de montrer que je sais coder proprement un CMS complet, en m’amusant.",
    type: "Fullstack",
    year: 2025,
    ...
    gallery: [],
    challenges: [
      "Créer un CMS complet avec planification automatique d’articles",
      "Gérer l’authentification, la modération et les permissions",
      "Trouver le bon équilibre entre humour visuel et performance technique",
    ],
    demoUrl: "https://technogorafi.vercel.app",
    githubUrl: "https://github.com/HrodWolfS/Technogorafi.git",
    featured: false,
    mobileFriendly: true,
  },
];
