...
import { Search, Filter, ArrowUpRight, Github } from 'lucide-react'
...
export default function Projects() {
  ...
  const types = Array.from(new Set(projectsData.map(project => project.type)))
  const years = Array.from(new Set(projectsData.map(project => project.year)))
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-8">
            Projets
            <span className="text-[rgb(var(--accent-neon))] neon-glow"> & Réalisations</span>
          </h1>
